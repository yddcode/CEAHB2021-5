...
def read_image(img_name):
    ...
    im = im.resize((244, 244), Image.BILINEAR) # 
    data = np.array(im)
    # print(data.shape)
    return data
...
model.add(Conv2D(64,(3,3), strides = (1,1), input_shape = (244,244,1), padding = 'same', activation = 'relu'))
...
adam = Adam(lr=0.001, beta_1=0.9, beta_2=0.99, epsilon=1e-08, amsgrad=True) # , beta_1=0.9, beta_2=0.999
...
plt.savefig('./trainvgglr001adam40spp.png', dpi = 600)
plt.figure()
...
plt.legend()
plt.savefig('./tlossvgglr001adam40spp.png', dpi = 600)
# plt.show()
...
print('vgg lr001adam 20e spp Test loss:', val_loss)
print('Test accuracy:', val_acc)
print('Train loss:', loss)
print('Train accuracy:', accu)

print('model vgg lr001adam 20 epoch spp net Test classify_report : \n', classify_report)
